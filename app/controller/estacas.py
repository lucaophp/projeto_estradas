...
from ..controller.curvas import Curvas as CurvasController
...
class Estacas:
    ...
    def recalcular(self,dist=0):
        if dist <= 0:
            dist = self.model.distancia
            estaca = self.model.estaca
    ...
    def curva(self):
        ...
        controller = CurvasController(self.iface,self.model.id_filename,self.model.tipo(),self)
        controller.run()
